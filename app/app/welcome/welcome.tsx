...
export const Welcome = ({ homepageData }: WelcomeProps) => {
  ...
  return (
    <main className="w-full min-h-screen bg-gray-200 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <CategoryCard name="CATEGORIA TESTE TIPO" description="DESCOBRE UMA NOVA CATEGORIA" media={{image: "/images/shoe.png", hover: "/images/footer.jpg"}} link="#" />

      <ProductCard name="Sapato Que é Um Teste" media={{image: "/images/personWshoe.png", hover:"/images/footer.jpg"}} link="#"/>
    </main>
  );
}
