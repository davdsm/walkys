export const translations = {
    pt: {
        ...
        // User backoffice (dashboard, orders, catalog)
        userBackoffice: {
            greetingHi: "Olá",
            goodToHave: "Que bom ter-te",
            youBack: "de volta!",
            orders: "Pedidos",
            order: "Pedido",
            catalog: "Catálogo",
            ...
            noOrdersYet: "Ainda não tem pedidos.",
            noProductsAssigned: "Ainda não há produtos atribuídos à sua conta. Contacte o administrador.",
            noProductsFound: "Nenhum produto encontrado.",
            userFallback: "Utilizador",
            orderSuccessTitle: "Pedido confirmado",
            orderSuccessMessage: "O seu pedido foi registado com sucesso.",
            goToHome: "Ir ao início",
            goToOrders: "Ver pedidos",
            orderStatusNew: "Novo",
            orderStatusProcessing: "Em processamento",
            orderStatusSended: "Enviado",
    ...
    en: {
        ...
        userBackoffice: {
            ...
            noProductsAssigned: "No products have been assigned to your account. Please contact your administrator.",
