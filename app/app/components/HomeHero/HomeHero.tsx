...
export const HomeHero = ({
  ...
  return (
    <article className="min-h-[100dvh] w-full max-w-full pt-60 pb-12 md:pt-12 md:pb-12 flex flex-col justify-center items-center px-5 sm:px-6 lg:px-20 relative">
