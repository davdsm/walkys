...
export const AnimatedBackground = ({
    ...
    return <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 4 }} ref={containerRef} className={`w-full h-full overflow-hidden ${className}`} style={style} />;
}
