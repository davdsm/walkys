...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const offscreen = position === "left" ? -100 : 120;
    ...
    <div className={`sm-scope z-40 w-full h-full`}>
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="fixed h-screen staggered-menu-panel top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-50 backdrop-blur-[12px]"
        ...
        >
          <div className="pt-20 sm-panel-inner flex-1 flex flex-col gap-5">
                ...
                items.map((it, idx) => (
                  ...
                  >
                    <Link
                      ...
                      data-index={idx + 1}
                    >
                      <span className="font-sans sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform text-[3rem]">
                        {it.label}
                      </span>
                    </Link>
                  </li>
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              ...
              >
                <h3 className="font-sans sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#ff0000)]">
                  Socials
                </h3>
                <ul
