...
export const Footer = ({ variant = "light" }: { variant?: "light" | "dark" }) => {
  const { t } = useLanguage();
  ...
  return (
    <footer id="main-footer" className={`md:p-16 p-4 ${variant === "light" ? "bg-[#F5F5F5]" : "bg-black "}`}>
      <div className="rounded-3xl bg-[#191C19] text-white px-6 py-16 md:px-20 md:py-16 font-sans relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-32 flex-col md:flex-row">
              ...
              <div className="flex gap-32">
                ...
                <div className="flex flex-col gap-12 min-w-[400px]">
                  <div>
                    <h4 className="text-[10px] font-bold uppercase tracking-[0.15em] text-white/50 mb-5">
                      {t.footer.contact}
                    </h4>
                    <a
                      href="tel:+351253412421"
                      className="text-[32px] font-light tracking-tight hover:text-white/70 transition-colors block"
                    >
                      ( +351 253 412 421 )
                    </a>
                  </div>
